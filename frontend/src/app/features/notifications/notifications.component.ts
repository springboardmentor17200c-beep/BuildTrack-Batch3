...
export class NotificationsComponent implements OnInit {
  ...
  getLeftColor(type: string): string {
    switch (type) {
      case 'Project Update':        return '#3b82f6';
      case 'Task Assignment':       return '#06b6d4';
      case 'Procurement Alert':     return '#ff7a00';
      case 'Attendance Alert':      return '#10b981';
      case 'Deadline Notification': return '#ef4444';
      case 'System Notification':   return '#64748b';
